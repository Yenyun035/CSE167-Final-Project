...
RTSceneViewer: main.o Shader.o Camera.o RTObj.o RTScene.o Image.o shaders/lighting.frag shaders/projective.vert
	$(CC) -o RTSceneViewer main.o Shader.o Camera.o RTObj.o RTScene.o Image.o $(LDFLAGS)
